 ...
 */
 ...
 {
     auto *deco = qobject_cast<Lingmo::Decoration*>(decoration.data());
     if (!deco) {
         setVisible(false);
         return;
     }
     ...
     auto *cPtr = clientPtr.data();
 
     switch (type) {
     case KDecoration2::DecorationButtonType::Menu:
         break;
     case KDecoration2::DecorationButtonType::Minimize:
         setVisible(cPtr->isMinimizeable());
         connect(cPtr, &KDecoration2::DecoratedClient::minimizeableChanged, this, &Button::setVisible);
         break;
     case KDecoration2::DecorationButtonType::Maximize:
         setVisible(cPtr->isMaximizeable());
         connect(cPtr, &KDecoration2::DecoratedClient::maximizeableChanged, this, &Button::setVisible);
         break;
     case KDecoration2::DecorationButtonType::Close:
         setVisible(cPtr->isCloseable());
         connect(cPtr, &KDecoration2::DecoratedClient::closeableChanged, this, &Button::setVisible);
         break;
     default:
         setVisible(false);
         break;
